...
{
    /// <inheritdoc />
    public partial class DistribuidoraMinoristaDB01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoriaProducto_Categoria_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categoria",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProveedorProducto", x => new { x.ProductoId, x.ProveedorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacturaDetalleFactura", x => new { x.DetalleFacturaId, x.FacturaId });
                    table.ForeignKey(
                        name: "FK_FacturaDetalleFactura_DetalleFactura_DetalleFacturaId",
                        column: x => x.DetalleFacturaId,
                        principalTable: "DetalleFactura",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FacturaDetalleFactura_Factura_FacturaId",
                        column: x => x.FacturaId,
                        principalTable: "Factura",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacturaDetalleFactura_FacturaId",
                table: "FacturaDetalleFactura",
                column: "FacturaId");
